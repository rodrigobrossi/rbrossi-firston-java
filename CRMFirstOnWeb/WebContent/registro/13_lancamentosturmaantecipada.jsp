...
<head>
<title>FirstOn - <%=trd.Traduz("Registro")%> - <%=trd.Traduz("LanCamentos Turma Antecipada")%></title>
          ...
          <td width="100%" align="center"> 
            <table border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td class="trontrk" width="297" align="center">LanCamentos Turma Antecipada</td>
