...
<%
	...
	String cti_codigo = (String) request.getParameter("pre");
	String competencia = (String) request.getParameter("competencia"
			+ cti_codigo);
	String titulo = (String) request
			.getParameter("titulo" + cti_codigo);
%>
				...
				<table border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="13"><img src="../art/bit.gif" width="13"
							height="15"></td>
						<td class="trontrk"><%=trd.Traduz("ALTERACAO DE COMPETENCIA POR TITULO")%></td>
						<td width="13"><img src="../art/bit.gif" width="13"
							height="15"></td>
					</tr>
				</table>
			...
			<tr>
				...
				<table border="0" cellspacing="2" cellpadding="3" width="90%">
					<tr class="celnortab">
						...
						<br>
						<input type="hidden" name="cti_codigo" value="<%=cti_codigo%>">
						...
						<select name="sel_titulo">
							<%
								...
								while (rs1.next()) {
									...
									if (rs1.getString(1).equals(titulo)) {
							%>
						...
						<select name="sel_competencia">
							<%
								...
								while (rs.next()) {
									if (rs.getString(1).equals(competencia)) {
							%>
