...
if (!(request.getParameter("filtro") == null)){ 
 filtro = " AND PLANOCURSO.PCU_DESCRICAO1 >= '" + request.getParameter("filtro") + "' ";
}

ResultSet rs = null;
String query = "SELECT PLANOCURSO.*, CURSO.CUR_NOME FROM PLANOCURSO, CURSO WHERE CURSO.CUR_CODIGO = PLANOCURSO.CUR_CODIGO " + curso + filtro + " ORDER BY CURSO.CUR_NOME"; 
...
<head>
<title>FirstOn - <%=trd.Traduz("Cadastro")%> - <%=trd.Traduz("Cadastro de Plano de Curso")%></title>
...
function inclui(){
  ...
  frm.action ="inclusaodeplanodecurso.jsp";
  frm.submit();
  return false; 
  }
function altera(){
...
function exclui(){
  ...
  frm.action ="planocursograva.jsp";
  frm.submit();
  return false; 
  }
</script>
          ...
          <td width="100%"> 
            <table border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td width="13"><img src="../art/bit.gif" width="13" height="15"></td>
                <td class="trontrk" width="229"><%=trd.Traduz("CADASTRO DE PLANO DE CURSO")%></td>
      ...
      <FORM name = "frm">
          <td valign="top"> <img src="../art/bit.gif" width="159" height="1"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                  <td height="20" class="ctfontc" align="center">&nbsp; <%=trd.Traduz("DESCRICAO DO PLANO DE CURSO")%>: 
            ...
            <td width="10">&nbsp;</td>
                    ...
                    <table border="0" cellspacing="1" cellpadding="2" width="80%">
                      <tr> 
                        ...
                        <td width="56%" class="celtittab"><%=trd.Traduz("NOME DO PLANO DE CURSO")%></td>
                      </tr>                     
                  <%  
            boolean check = false;
                   do
             ...
             <%}
               ...
               {check = true;%>
                        ...
                        <td width="40%"><%=rs.getString(7)%></td>
            <td width="56%"><%=rs.getString(3)%></td>
                      </tr>                    
                    <%
                    }
                   while (rs.next());
