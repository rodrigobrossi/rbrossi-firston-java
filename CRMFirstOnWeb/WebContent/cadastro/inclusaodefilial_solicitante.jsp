...
//Variaveis
String query="", funcionario_cod="", funcionario_nome="", cbo_func="", cbo_tipo="", txt_login="";
String inc_alt="";
ResultSet rs = null; 
...
<script language="JavaScript">
  function inclui() {
    window.open("inclusaodesolicitante_sql.jsp?tipo_op=IF&<%=parametros%>&fil_cod="+frm_inc_solic.cbo_fil.value+"&padrao="+frm_inc_solic.padrao.checked+"&inc_alt=<%=inc_alt%>", "_parent");
    return true;
  }
    ...
    <FORM name="frm_inc_solic" action="inclusaodesolicitante.jsp">
          <td valign="top"> <img src="../art/bit.gif" width="159" height="1">&nbsp;<br><center>
                <table border="0" cellspacing="2" cellpadding="2" width="60%">
                  <tr align="center">
                    <td class="ftverdanacinza"><%=trd.Traduz("Funcionario")%>: &nbsp;
                      <input type="text" disabled name="txt_func_off" value="<%=funcionario_nome%>" size="40">
                    </td>
                  </tr>
                  <tr><td>&nbsp;</td></tr>
                  <tr align="center">
                    <td class="ftverdanacinza"><%=trd.Traduz("Filial")%>:&nbsp;
                      <select name="cbo_fil">
                        <option value=""></option>
...
<%                          } while (rs.next());
                  ...
                  <tr> 
                    <td align="center">&nbsp;<br>
                      <input type="button" value=<%=("\""+trd.Traduz("OK")+"\"")%> onclick="inclui();">
                      &nbsp; &nbsp; 
