...
<%
	 ...
	 */
	//*************************
	FODBConnectionBean conexaoplano = new FODBConnectionBean();
	FODBConnectionBean conexaofiltro = new FODBConnectionBean();

	FODBConnectionBean conexaolegenda = new FODBConnectionBean();
	...
	conexaoplano.realizaConexao((String) session
	...
	conexaofiltro.realizaConexao((String) session
			.getAttribute("s_conexao"), (String) session
			.getAttribute("s_usubanco"), (String) session
			.getAttribute("s_senbanco"), (String) session
			.getAttribute("s_driverbanco"));
	conexaolegenda.realizaConexao((String) session
			.getAttribute("s_conexao"), (String) session
			.getAttribute("s_usubanco"), (String) session
			.getAttribute("s_senbanco"), (String) session
			.getAttribute("s_driverbanco"));
	...
	ResultSet rs_plano = null, rs = null, rs_filtro = null, rs_legenda = null;

	String plano_atual = "";
	DecimalFormat dcf = new DecimalFormat("0.00");

	String query_plano = "SELECT PLA_NOME FROM PLANO WHERE PLA_CODIGO = "
			+ usu_plano;
	rs_plano = conexaoplano.executaConsulta(query_plano);
	if (rs_plano.next())
	...
	cor.addElement("#0000FF");
	cor.addElement("#8A2BE2");
	cor.addElement("#A52A2A");
	cor.addElement("#5F9EA0");
	cor.addElement("#7FFF00");
	cor.addElement("#D2691E");
	cor.addElement("#FF7F50");
	cor.addElement("#6495ED");
	cor.addElement("#FFF8DC");
	cor.addElement("#DC143C");
	cor.addElement("#00FFFF");
	cor.addElement("#00008B");
	cor.addElement("#008B8B");
	cor.addElement("#B8860B");
	cor.addElement("#A9A9A9");
	cor.addElement("#006400");
	cor.addElement("#BDB76B");
	cor.addElement("#8B008B");
	cor.addElement("#556B2F");
	cor.addElement("#FF8C00");
	cor.addElement("#9932CC");
	cor.addElement("#8B0000");
	cor.addElement("#E9967A");
	cor.addElement("#8FBC8F");
	cor.addElement("#483D8B");
	cor.addElement("#2F4F4F");
	cor.addElement("#00CED1");
	cor.addElement("#9400D3");
	cor.addElement("#FF1493");
	cor.addElement("#00BFFF");
	cor.addElement("#696969");
	cor.addElement("#1E90FF");
	cor.addElement("#B22222");
	cor.addElement("#FFFAF0");
	cor.addElement("#228B22");
	cor.addElement("#FF00FF");
	cor.addElement("#DCDCDC");
	cor.addElement("#F8F8FF");
	cor.addElement("#FFD700");
	cor.addElement("#DAA520");
	cor.addElement("#808080");
	cor.addElement("#008000");
	cor.addElement("#ADFF2F");
	cor.addElement("#F0FFF0");
	cor.addElement("#FF69B4");
	cor.addElement("#CD5C5C");
	cor.addElement("#4B0082");
	cor.addElement("#FFFFF0");
	cor.addElement("#F0E68C");
	cor.addElement("#E6E6FA");
	cor.addElement("#FFF0F5");
	cor.addElement("#7CFC00");
	cor.addElement("#FFFACD");
	cor.addElement("#ADD8E6");
	cor.addElement("#F08080");
	cor.addElement("#E0FFFF");
	cor.addElement("#FAFAD2");
	cor.addElement("#90EE90");
	cor.addElement("#D3D3D3");
	cor.addElement("#FFB6C1");
	cor.addElement("#FFA07A");
	cor.addElement("#20B2AA");
	cor.addElement("#87CEFA");
	cor.addElement("#778899");
	cor.addElement("#B0C4DE");
	cor.addElement("#FFFFE0");
	cor.addElement("#00FF00");
	cor.addElement("#32CD32");
	cor.addElement("#FAF0E6");
	cor.addElement("#FF00FF");
	cor.addElement("#800000");
	cor.addElement("#66CDAA");
	cor.addElement("#0000CD");
	cor.addElement("#9370D8");
	cor.addElement("#3CB371");
	cor.addElement("#7B68EE");
	cor.addElement("#00FA9A");
	cor.addElement("#48D1CC");
	cor.addElement("#C71585");
	cor.addElement("#191970");
	cor.addElement("#F5FFFA");
	cor.addElement("#FFE4E1");
	cor.addElement("#FFE4B5");
	cor.addElement("#FFDEAD");
	cor.addElement("#000080");
	cor.addElement("#FDF5E6");
	cor.addElement("#808000");
	cor.addElement("#688E23");
	cor.addElement("#FFA500");
	cor.addElement("#FF4500");
	cor.addElement("#DA70D6");
	cor.addElement("#EEE8AA");
	cor.addElement("#98FB98");
	cor.addElement("#AFEEEE");
	cor.addElement("#D87093");
	cor.addElement("#FFEFD5");
	cor.addElement("#FFDAB9");
	cor.addElement("#CD853F");
	cor.addElement("#FFC0CB");
	cor.addElement("#DDA0DD");
	cor.addElement("#B0E0E6");
	cor.addElement("#800080");
	cor.addElement("#FF0000");
	cor.addElement("#BC8F8F");
	cor.addElement("#4169E1");
	cor.addElement("#8B4513");
	cor.addElement("#FA8072");
	cor.addElement("#F4A460");
	cor.addElement("#2E8B57");
	cor.addElement("#FFF5EE");
	cor.addElement("#A0522D");
	cor.addElement("#C0C0C0");
	cor.addElement("#87CEEB");
	cor.addElement("#6A5ACD");
	cor.addElement("#708090");
	cor.addElement("#FFFAFA");
	cor.addElement("#00FF7F");
	cor.addElement("#4682B4");
	cor.addElement("#D2B48C");
	cor.addElement("#008080");
	cor.addElement("#D8BFD8");
	cor.addElement("#FF6347");
	cor.addElement("#40E0D0");
	cor.addElement("#EE82EE");
	cor.addElement("#F5DEB3");
	cor.addElement("#336688");
	cor.addElement("#F0F8FF");
	cor.addElement("#FAEBD7");
	cor.addElement("#00FFFF");
	cor.addElement("#7FFFD4");
	cor.addElement("#F0FFFF");
	cor.addElement("#F5F5DC");
	cor.addElement("#FFE4C4");
	cor.addElement("#DEB887");
	cor.addElement("#FFEBCD");
	cor.addElement("#FFFFFF");
	cor.addElement("#F5F5F5");
	...
	if (request.getParameter("cbo_grupo").equals("T3")) {//Tabela3
		...
		group = "GROUP BY T3.TB3_DESCRICAO ";
		agrupamento = "R";
	}
	...
	String valor = request.getParameter("rdo_valor");
	...
	//Consulta dos dados
	query = query
			+ "FROM ASSUNTO A, TITULO TI, CURSO CU, TREINAMENTO T, CARGO CA, FUNCIONARIO F, DEPTO D, FILIAL FI, "
			...
			+ "AND T1.TB1_CODIGO =* F.TB1_CODIGO "
			+ "AND T2.TB2_CODIGO =* F.TB2_CODIGO "
			+ "AND T3.TB3_CODIGO =* F.TB3_CODIGO "
	...
	if (!request.getParameter("cbo_solic").equals("")) { //filtro solicitante
		query = query + "AND F.FUN_CODSOLIC = "
				+ request.getParameter("cbo_solic") + " ";
		query_filtro = "SELECT FUN_NOME FROM FUNCIONARIO WHERE FUN_CODIGO = "
				+ request.getParameter("cbo_solic") + " ";
		rs_filtro = conexaofiltro.executaConsulta(query_filtro);
		if (rs_filtro.next())
			filtros = filtros + trd.Traduz("SOLICITANTE") + ": "
					+ rs_filtro.getString(1) + "<BR>";
	}
	if (!request.getParameter("cbo_tipo").equals("")) { //filtro tipo curso
		query = query + "AND CU.TCU_CODIGO = "
				+ request.getParameter("cbo_tipo") + " ";
		query_filtro = "SELECT TCU_NOME FROM TIPOCURSO WHERE TCU_CODIGO = "
				+ request.getParameter("cbo_tipo") + " ";
		rs_filtro = conexaofiltro.executaConsulta(query_filtro);
		if (rs_filtro.next())
			filtros = filtros + trd.Traduz("TIPO DE CURSO") + ": "
					+ rs_filtro.getString(1) + "<BR>";
	}
	if (!request.getParameter("cbo_departamento").equals("")) { //filtro departamento
		query = query + "AND F.DEP_CODIGO = "
				+ request.getParameter("cbo_departamento") + " ";
		query_filtro = "SELECT DEP_NOME FROM DEPTO WHERE DEP_CODIGO = "
				+ request.getParameter("cbo_departamento") + " ";
		rs_filtro = conexaofiltro.executaConsulta(query_filtro);
		if (rs_filtro.next())
			filtros = filtros + trd.Traduz("DEPARTAMENTO") + ": "
					+ rs_filtro.getString(1) + "<BR>";
	}
	if (!request.getParameter("cbo_cargo").equals("")) { //filtro cargo
		query = query + "AND F.CAR_CODIGO = "
				+ request.getParameter("cbo_cargo") + " ";
		query_filtro = "SELECT CAR_NOME FROM CARGO WHERE CAR_CODIGO = "
				+ request.getParameter("cbo_cargo") + " ";
		rs_filtro = conexaofiltro.executaConsulta(query_filtro);
		if (rs_filtro.next())
			filtros = filtros + trd.Traduz("CARGO") + ": "
					+ rs_filtro.getString(1) + "<BR>";
	}
	if (!request.getParameter("cbo_curso").equals("")) { //filtro curso
		query = query + "AND T.CUR_CODIGO = "
				+ request.getParameter("cbo_curso") + " ";
		query_filtro = "SELECT CUR_NOME FROM CURSO WHERE CUR_CODIGO = "
				+ request.getParameter("cbo_curso") + " ";
		rs_filtro = conexaofiltro.executaConsulta(query_filtro);
		if (rs_filtro.next())
			filtros = filtros + trd.Traduz("CURSO") + ": "
					+ rs_filtro.getString(1) + "<BR>";
	}
	if (!request.getParameter("cbo_filial").equals("")) { //filtro filial
		query = query + "AND F.FIL_CODIGO = "
				+ request.getParameter("cbo_filial") + " ";
		query_filtro = "SELECT FIL_NOME FROM FILIAL WHERE FIL_CODIGO = "
				+ request.getParameter("cbo_filial") + " ";
		rs_filtro = conexaofiltro.executaConsulta(query_filtro);
		if (rs_filtro.next())
			filtros = filtros + trd.Traduz("FILIAL") + ": "
					+ rs_filtro.getString(1) + "<BR>";
	}
	if (!request.getParameter("cbo_titulo").equals("")) { //filtro titulo
		query = query + "AND CU.TIT_CODIGO = "
				+ request.getParameter("cbo_titulo") + " ";
		query_filtro = "SELECT TIT_NOME FROM TITULO WHERE TIT_CODIGO = "
				+ request.getParameter("cbo_titulo") + " ";
		rs_filtro = conexaofiltro.executaConsulta(query_filtro);
		if (rs_filtro.next())
			filtros = filtros + trd.Traduz("TITULO") + ": "
					+ rs_filtro.getString(1) + "<BR>";
	}
	if (!request.getParameter("cbo_regiao").equals("")) { //filtro regiao
		query = query + "AND FI.REG_CODIGO = "
				+ request.getParameter("cbo_regiao") + " ";
		query_filtro = "SELECT REG_NOME FROM REGIAO WHERE REG_CODIGO = "
				+ request.getParameter("cbo_regiao") + " ";
		rs_filtro = conexaofiltro.executaConsulta(query_filtro);
		if (rs_filtro.next())
			filtros = filtros + trd.Traduz("REGIAO") + ": "
					+ rs_filtro.getString(1) + "<BR>";
	}
	if (!request.getParameter("cbo_entidade").equals("")) { //filtro entidade
		query = query + "AND T.EMP_CODIGO = "
				+ request.getParameter("cbo_entidade") + " ";
		query_filtro = "SELECT EMP_NOME FROM EMPRESA WHERE EMP_CODIGO = "
				+ request.getParameter("cbo_entidade") + " ";
		rs_filtro = conexaofiltro.executaConsulta(query_filtro);
		if (rs_filtro.next())
			filtros = filtros + trd.Traduz("ENTIDADE") + ": "
					+ rs_filtro.getString(1) + "<BR>";
	}
	if (!request.getParameter("cbo_func").equals("")) { //filtro funcionario
		query = query + "AND F.FUN_CODIGO = "
				+ request.getParameter("cbo_func") + " ";
		query_filtro = "SELECT FUN_NOME FROM FUNCIONARIO WHERE FUN_CODIGO = "
				+ request.getParameter("cbo_func") + " ";
		rs_filtro = conexaofiltro.executaConsulta(query_filtro);
		if (rs_filtro.next())
			filtros = filtros + trd.Traduz("FUNCIONARIO") + ": "
					+ rs_filtro.getString(1) + "<BR>";
	}
	if (!request.getParameter("cbo_tb1").equals("")) { //filtro tabela1
		query = query + "AND F.TB1_CODIGO = "
				+ request.getParameter("cbo_tb1") + " ";
		query_filtro = "SELECT TB1_NOME FROM TABELA1 WHERE TB1_CODIGO = "
				+ request.getParameter("cbo_tb1") + " ";
		rs_filtro = conexaofiltro.executaConsulta(query_filtro);
		if (rs_filtro.next())
			filtros = filtros + trd.Traduz("TABELA1") + ": "
					+ rs_filtro.getString(1) + "<BR>";
	}
	if (!request.getParameter("cbo_tb2").equals("")) { //filtro tabela2
		query = query + "AND F.TB2_CODIGO = "
				+ request.getParameter("cbo_tb2") + " ";
		query_filtro = "SELECT TB2_NOME FROM TABELA2 WHERE TB2_CODIGO = "
				+ request.getParameter("cbo_tb2") + " ";
		rs_filtro = conexaofiltro.executaConsulta(query_filtro);
		if (rs_filtro.next())
			filtros = filtros + trd.Traduz("TABELA2") + ": "
					+ rs_filtro.getString(1) + "<BR>";
	}
	if (!request.getParameter("cbo_tb3").equals("")) { //filtro tabela3
		query = query + "AND F.TB3_CODIGO = "
				+ request.getParameter("cbo_tb3") + " ";
		query_filtro = "SELECT TB3_DESCRICAO FROM TABELA3 WHERE TB3_CODIGO = "
				+ request.getParameter("cbo_tb3") + " ";
		rs_filtro = conexaofiltro.executaConsulta(query_filtro);
		if (rs_filtro.next())
			filtros = filtros + trd.Traduz("TABELA3") + ": "
					+ rs_filtro.getString(1) + "<BR>";
	}
	if (!request.getParameter("cbo_tb4").equals("")) { //filtro tabela4
		query = query + "AND F.TB4_CODIGO = "
				+ request.getParameter("cbo_tb4") + " ";
		query_filtro = "SELECT TB4_DESCRICAO FROM TABELA4 WHERE TB4_CODIGO = "
				+ request.getParameter("cbo_tb4") + " ";
		rs_filtro = conexaofiltro.executaConsulta(query_filtro);
		if (rs_filtro.next())
			filtros = filtros + trd.Traduz("TABELA4") + ": "
					+ rs_filtro.getString(1) + "<BR>";
	}
...
<%
	...
	if (rs.next()) {
		...
		if (agrupamento.equals("R")) {
			do {
				...
				if (rs.getFloat(2) > maior)
					maior = rs.getFloat(2);
				if (request.getParameter("cbo_grupo").equals("SO")) {
					query_legenda = "SELECT FUN_NOME FROM FUNCIONARIO WHERE FUN_CODIGO = "
							+ rs.getString(1);
					rs_legenda = conexaolegenda
							.executaConsulta(query_legenda);
					if (rs_legenda.next())
						legenda.addElement(rs_legenda.getString(1));
				} else {
		...
		if (agrupamento.equals("P")) {
			...
			if (real > plan && real > just)
				maior = real;
			if (plan > real && plan > just)
				maior = plan;
			if (just > plan && just > real)
				maior = just;
		...
		for (int i = 0; dados.size() > i; i++)
			if (Float.valueOf(dados.elementAt(i) + "").floatValue() >= maior_graf)
				maior_graf = Float.valueOf(dados.elementAt(i) + "")
						.floatValue();
...
function OnLoadPage() {
    ...
    if(BarGraph.setHeader("<%=titulo%>", BarGraph.VERTICAL, "#FFFFFF", <%=dados.size()%>)) {
       ...
       //BarGraph.setAttributes(1, "Jan", "15", 15, BarGraph.SOLID, "#EE3838");
        <%for (int i = 0; dados.size() > i; i++) {%>
       	<%="BarGraph.setAttributes("
							+ (i + 1)
							+ ", \""
							+ largura
							+ "\",\""
							+ dcf.format(Float.valueOf(dados.elementAt(i) + "")
									.floatValue())
							+ "\", "
							+ ((Float.valueOf(dados.elementAt(i) + "")
									.floatValue() * 100) / maior_graf)
							+ ", BarGraph.SOLID, \"" + cor.elementAt(i)
							+ "\");"%>
	<%}%>    
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					<tr>
						<td class="trcurso"><img src="../art/Logo_Cliente.gif"
							width="317" height="42"></td>
					</tr>
					<tr>
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="3">
					<tr>
						<td width="100%" class="ftverdanapreto"><%=trd.Traduz("FILTROS ESCOLHIDOS")%>:
						<span class="ftverdanacinza"> <%=filtros%> </span></td>
					</tr>
				</table>
				<table width="100%" height="100%" border="0">
					...
					<tr>
						<td align="center" width="75%"><applet codebase="."
							code="com.gencode.util.applet.BarGraph.class" name="BarGraph"
							width=700 height=400></applet></td>
						<td width="25%">
				...
				<table width="100%" height="100%" border="0">
					...
					<tr>
						<td align="center" bgcolor="FFFFFF"><img
							src="../art/em_peq.gif" border="0"> <br>
						<br>
...
<tr>
	<td align="center" bgcolor="FFFFFF"><img src="../art/em_peq.gif"
		border="0"> <br>
	<br>
	<font face="Verdana" size="1" color="000000"><%=trd.Traduz("NENHUM ITEM SELECIONADO")%></font>
	<br>
...
<%
	...
	conexaofiltro.finalizaConexao();
	//conexaofiltro.finalizaBD();

	conexaolegenda.finalizaConexao();
	//conexaolegenda.finalizaBD();
