				...
				<%
					...
					if(rs.next())
					{
						do
						{
							...
							{
								query = query + "AND P.PRO_INICIO >= CONVERT(datetime, '"+request.getParameter("text_datainicio")+"', 103) ";
							}
							
							//Filtro por Data Final
							if(!request.getParameter("text_datafinal").equals(""))
							{
								query = query + "AND P.PRO_FIM <= CONVERT(datetime, '"+request.getParameter("text_datafinal")+"', 103) ";
							}	
