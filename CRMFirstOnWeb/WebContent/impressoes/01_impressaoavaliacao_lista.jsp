...
query_grid = "SELECT DISTINCT F.FUN_CODIGO, F.FUN_NOME, AVD.PRO_CODIGO, P.PRO_ENVLAUDO, P.PRO_FIM, "+
	...
	{
		query_grid = query_grid + " AND P.PRO_INICIO >= DATEFMT("+request.getParameter("text_datainicio")+") ";
	}
							
	//Filtro por Data Final
	if(!request.getParameter("text_datafinal").equals(""))
	{
		query_grid = query_grid + " AND P.PRO_FIM <= DATEFMT("+request.getParameter("text_datafinal")+") ";
	}	
