...
<table width="100%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<table border="0" cellspacing="1" cellpadding="2" width="80%">
			<tr>
				<td colspan="5">
				<div align="center" class="ftverdanacinza"><b><%=trd.Traduz("Limpa Senha")%></b></div>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
	...
	<tr>
		...
		<div align="center"><input type="submit" name="Submit"
			value="Limpar" class="botcin" onClick="return limpa()"> <!--<input type="reset" name="Submit2" value="Limpar" class="botcin">-->
		</div>
		</td>
	</tr>
	<tr>
