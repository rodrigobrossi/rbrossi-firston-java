...
<html>
<head>
<title>FirstOn - <%=trd.Traduz("AVALIACAO")%> - <%=trd.Traduz("RESPOSTAS")%></title>
<script language="JavaScript" src="/js/scripts.js"></script>

<script language="JavaScript">
function filtra(){
  //document.frm.tipo.value = "F";
  frm.action ="resposta.jsp";
  frm.submit();
  return false; 
}
function inclui(){
  document.frm.tipo.value = "I";
  frm.action ="inclusaoderespostas.jsp";
  frm.submit();
  return false; 
}
function altera(){
				...
				<table border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="13"><img src="../art/bit.gif" width="13"
							height="15"></td>
						<td class="trontrk" align="center"><%=trd.Traduz("INSERIR RESPOSTA")%></td>
 ...
 %> <input type="text" name="filtro" value="<%=valorFiltro%>"
					...
					<tr>
						...
						<table border="0" cellspacing="1" cellpadding="2" width="50%">
							...
							<tr>
								<td width="4%">&nbsp;</td>
								<td width="96%" class="celtittab"><%=trd.Traduz("RESPOSTAS")%>
								</td>
							</tr>
							<%
								String ok = "";
