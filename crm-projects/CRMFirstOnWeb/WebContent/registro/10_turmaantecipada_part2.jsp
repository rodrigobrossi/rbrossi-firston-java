...
conexaoC.realizaConexao((String)session.getAttribute("s_conexao"), (String)session.getAttribute("s_usubanco"), (String)session.getAttribute("s_senbanco"), (String)session.getAttribute("s_driverbanco")); 
conexaoT.realizaConexao((String)session.getAttribute("s_conexao"), (String)session.getAttribute("s_usubanco"), (String)session.getAttribute("s_senbanco"), (String)session.getAttribute("s_driverbanco")); 
                        ...
                        <tr> 
                          <td> 
                            <table border="1" cellspacing="0" cellpadding="1" bordercolor="#000000">
                              <tr> 
                                <td onMouseOver="this.className='ctonlnk2';" OnClick="incpartpla()" width="190" height="22" align=center class="botver"><a href="#" onClick = "return incpartpla();" class="txbotver"><%=trd.Traduz("INCLUIR PLANEJADOS")%></a></td>
                              </tr>
                            </table>
                          </td>
			  <td width="10">&nbsp;</td>
                          <td> 
                            <table border="1" cellspacing="0" cellpadding="1" bordercolor="#000000">
                              <tr> 
                                <td onMouseOver="this.className='ctonlnk2';" onClick="incpart();" width="190" height="22" align=center class="botver"><a href="#" onClick = "return incpart();" class="txbotver"><%=trd.Traduz("INCLUIR NAO PLANEJADOS")%></a></td>
                              </tr>
                            </table>
                          </td>
                          <td width="10">&nbsp;</td>
                          <td> 
                            ...
                            <table border="1" cellspacing="0" cellpadding="1" bordercolor="#000000">
                              <tr> 
                                <td onMouseOver="this.className='ctonlnk2';" OnClick="excpart()" width="190" height="22" align=center class="botver"><a href="#" onClick = "return excpart();" class="txbotver"><%=trd.Traduz("EXCLUIR")%></a></td>
                              </tr>
                            </table>
                            <%}%>
                          </td>
                    ...
                    <table border="0" cellspacing="1" cellpadding="0" width="100%">
                      ...
                      <tr align="center">
                        <td class="ctfontc" valign="middle" colspan="100%"> * - <%=trd.Traduz("TERCEIRO")%>
                          ...
                          &nbsp;&nbsp;&nbsp;&nbsp;<img src="../art/red.gif" width="17" height="17"> = <%=trd.Traduz("NAO PLANEJADOS")%>
                        </td>
                      </tr>
                      <tr><td height="12" colspan="9"><img src="../art/bit.gif" width="1" height="1"></td></tr>
                      <tr><td height="1" class="ctvdiv" colspan="9"><img src="../art/bit.gif" width="1" height="1"></td></tr>
...
<%                    ResultSet rsTurma = null;
                      ...
                      if (rsTurma.next()) {
						...
						%>
                        <tr>
                            <td colspan="100%" align="left" class="ftverdanacinza"><font size="1"><a href="06_criarturmaantecipada.jsp" class="lnk">
                                <%=trd.Traduz("Curso")%>: <%=rsTurma.getString(1)%>
                                &nbsp;
...
<%                          funcvet.remove(rsgrid.getString(1));
				...
				%>
                        ...
                        <td width="4%"><div align="center"><%=rsgrid.getString(2)%></div></td>
                ...
                <td height="30" colspan="3" class="ctfundo"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="9">
                    <tr> 
                      ...
                      <%}%>
                      <td align="right" class="ctfontc" width="16%"><a href="#" name="valor" value = "<%=ult%>" onClick = "return ProximaPag(this);" class="ctoflnkb"><%=trd.Traduz("Ultima PAgina")%></a></td>
                    </tr>
                  </table>
                </td>
              </tr>
