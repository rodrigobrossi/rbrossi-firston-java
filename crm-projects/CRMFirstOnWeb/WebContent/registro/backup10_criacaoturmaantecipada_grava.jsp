...
<%
	...
	if (tipo.equals("I")) {
		...
		query_t = "SELECT MAX(TUR_CODIGO) FROM TURMA WHERE FUN_CODIGO = "
				...
				+ "AND CUR_CODIGO = "
				+ cur
				+ " AND TUR_DATAINICIO = CONVERT(datetime, '"
				+ dtini
				+ "', 103) " + "AND TUR_OBS = '" + obs + "' ";
		...
		if (!(instrutor.equals(""))) {
			query = "UPDATE TURMA SET EMP_CODIGO = " + entidade
					...
					+ "TUR_DATAINICIO = CONVERT(datetime, '" + dtini
					+ "', 103), "
					+ "TUR_DATAFINAL = CONVERT(datetime, '" + dtfim
					+ "', 103), TUR_DURACAO = " + dur + ", "
			...
			query = "UPDATE TURMA SET EMP_CODIGO = " + entidade
					...
					+ "TUR_DATAFINAL = CONVERT(datetime, '" + dtfim
					+ "', 103), TUR_DURACAO = " + dur + ", "
					+ "TUR_CUSTO = " + cuscur + ", CUR_CODIGO = " + cur
					+ ", " + "TUR_OBS = '" + obs + "', TUR_CUSTO2 = "
					+ cuslog + ", TUR_PARTICIPMIN = " + pmin + ", "
					+ "TUR_PARTICIPMAX = " + pmax + ", TCU_CODIGO = "
					+ tip + ", " + "TTR_CODIGO = " + tipo_treinamento
					+ ", TUR_VAGAS = " + vagas + " WHERE TUR_CODIGO = "
					+ turma;
