...
<table width="100%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td><input type="text" name="login" size="10" class="lginput">
				</td>
				<td width="30">&nbsp;</td>
				<td class="lgfont" width="55">Senha</td>
				<td><input type="password" name="senha" size="10"
					class="lginput"></td>
				<td width="10" align="center">&nbsp;</td>

				<td align="center"><input type="submit"
					onclick="return envia();" value="Entrar" class="botcin"></td>
				<td>&nbsp;</td>
			</tr>
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0" height="100%"
			...
			<tr>
				<td colspan="2" width="50%" align="center" height="92"><img
					src="art/logo_ser.gif" width="190" height="97"></td>
				<!--   <td height="92" align="center">&nbsp;</td> -->
				<td colspan="2" height="92" align="center" width="50%"><img
					src="art/Logo_Cliente.gif"></td>
			</tr>
			<tr>
				<td colspan="4" align="center" height="13" class="difont">

				<table width="45%" border="1" bordercolor="#39639d">
					<tr>
						<!--                <td align="right" width="25%"><img src="art/atencao_login.gif" width="52" height="52"></td>
          <td colspan="0" align="center" height="0">&nbsp;</td> -->
						<td align="center" height="13" class="difont" width="45%"><strong>
						<br>
						<div>Recomenda-se utilizar resolução de video igual ou
						superior a <font color="red"><b>1024x768</b></font>.</div>
						<div>Deve-se utilizar Browser <font color="red"><b>Internet
						Explorer 6</b></font> ou superior.</div>
						<div><a href="JavaScript:popup()" class="dilink">
						Configure corretamente seu Browser para uma melhor utilização. </a></div>
						</strong> <br>
						</td>
						<!--          <td colspan="0" align="center" height="0">&nbsp;</td> -->
					</tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<table border="0" cellspacing="0" cellpadding="0" width="665">
							<tr>
								<td width="23" height="13"><img src="art/bit.gif"
									width="20" height="10"></td>
								<td width="11" nowrap height="13"><img src="art/bit.gif"
								...
								%>
								<td nowrap class="difont" width="156" height="13"><a
									href="lista_climaorg.jsp" class="dilink"> Clima
								Organizacional </a></td>
								<%
								}
								%>
						...
						<td align="right" width="103" height="17"><img
							src="art/bit.gif" width="20" height="10"></td>
					</tr>
				</table>
				</td>
			</tr>
