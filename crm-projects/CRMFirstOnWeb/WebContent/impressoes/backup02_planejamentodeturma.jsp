...
if (!dt_inicio.equals("")) {
    query_filtro = query_filtro + "AND U.TUR_DATAINICIO >= CONVERT(DATETIME, '"+dt_inicio+"', 103) ";
    filtros = filtros + "<BR>" + trd.Traduz("DATA INICIAL") + ": " +dt_inicio;
}
if (!dt_fim.equals("")) {
    query_filtro = query_filtro + "AND U.TUR_DATAINICIO <= CONVERT(DATETIME, '"+dt_fim+"', 103) ";
