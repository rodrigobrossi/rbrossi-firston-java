...
<%
	...
	if (!(request.getParameter("filtro") == null)) {
		filtro = " WHERE JUS_NOME >= '"
		+ request.getParameter("filtro") + "' ";
	}

	ResultSet rs = null;
	String query = "SELECT JUS_CODIGO, JUS_NOME FROM JUSTIFICATIVA "
			+ filtro + "ORDER BY JUS_NOME";
%>
...
<head>
<title>FirstOn - <%=trd.Traduz("Cadastro")%> - <%=trd.Traduz("CADASTRO DE JUSTIFICATIVAS")%></title>
<script language="JavaScript" src="/js/scripts.js"></script>
<script language="JavaScript">
function filtra()
{
  document.frm.tipo.value = "F";
  frm.action ="justificativas.jsp";
  frm.submit();
  return false; 
}
function inclui()
{
  ...
  frm.action ="inclusaodejustif.jsp";
  frm.submit();
  return false; 
}
function altera()
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<table border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="13"><img src="../art/bit.gif" width="13"
							height="15"></td>
						<td class="trontrk"><%=trd.Traduz("CADASTRO DE JUSTIFICATIVAS")%></td>
						<td width="13"><img src="../art/bit.gif" width="13"
							height="15"></td>
					</tr>
				</table>
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td height="20" class="ctfontc" align="center">&nbsp; <%=trd.Traduz("LOCALIZAR POR JUSTIFICATIVA")%>:
						<%
 ...
 %>
					...
					<tr>
						...
						<%
							...
							if (per.contains("CADASTRO JUSTIFICATIVA - MANUTENCAO")) {
								mostraCheck = true;
						%>
 ...
 %>
						...
						<table border="0" cellspacing="1" cellpadding="2" width="80%">
							<tr>
								...
								if (existe) {
								%>
								<td width="96%" class="celtittab"><%=trd.Traduz("NOME DA JUSTIFICATIVA")%>
								<%
								} else {
								%>
