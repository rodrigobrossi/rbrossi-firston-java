<!--
Nome do arquivo: cadastro/tipos.jsp
Nome da funcionalidade: cadastro de tipos
Função: exibe os tipos e as funcionalidades, dependendo das permissões e 
...
<head>
<title>FirstOn - <%=trd.Traduz("Cadastro")%> - <%=trd.Traduz("Cadastro de Local")%></title>
...
function filtra(){
  ...
  frm.action ="tipos.jsp";
  frm.submit();
  return false; 
}
function inclui(){
    document.frm.tipo.value = "I";
  frm.action ="inclusaodetipo.jsp";
  frm.submit();
  return false; 
}
function altera(){
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<table border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="13"><img src="../art/bit.gif" width="13"
							height="15"></td>
						<td class="trontrk"><%=trd.Traduz("CADASTRO DE LOCAL")%></td>
						<td width="13"><img src="../art/bit.gif" width="13"
							height="15"></td>
					</tr>
				</table>
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td height="20" class="ctfontc" align="center">&nbsp; <%=trd.Traduz("LOCALIZAR POR TIPO")%>:
						<%
 ...
 %>
					...
					<tr>
						<td align="center">&nbsp;<br>
						<%
							query = "SELECT TCU_CODIGO, TCU_NOME FROM TIPOCURSO " + filtro
									+ " ORDER BY TCU_NOME";
							...
							if (per.contains("CADASTRO TIPO - MANUTENCAO")) {
								mostraCheck = true;
						%>
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
						...
						<table border="0" cellspacing="1" cellpadding="2" width="80%">
							<tr>
								...
								<%
									if (existe) {
								%>
								<td width="96%" class="celtittab"><%=trd.Traduz("LOCAL")%>
								<%
									} else {
								%>
