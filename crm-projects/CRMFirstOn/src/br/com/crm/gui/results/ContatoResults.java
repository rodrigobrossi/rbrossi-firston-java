 ...
 *
 */
public class ContatoResults extends AncestorFrame {
	...
	public void createGUI() {
		...
		table = new JTable(model = new ContatoTableModel());
...
class ContatoTableModel extends DefaultTableModel {
