 ...
 *
 */
public class ProfissaoClienteResults extends AncestorFrame {
	...
	private ProfissaoClienteTableModel model;

	public ProfissaoClienteResults() {
		createGUI();
	...
	public void createGUI() {
		...
		table = new JTable(model = new ProfissaoClienteTableModel());
...
class ProfissaoClienteTableModel extends DefaultTableModel {
	...
	public ProfissaoClienteTableModel() {
		loadModel();
...
ProfissaoClienteCTR ctr = new ProfissaoClienteCTR();
		ctr.setObject(new CrmProfissaoCliente());
		Iterator it = ctr.getData().iterator();
		while (it.hasNext()) {
			CrmProfissaoCliente element = (CrmProfissaoCliente) it.next();
	...
	public Object getValueAt(int column, int row) {
		...
		switch (row) {
		case 0:
			return ((CrmProfissaoCliente) model.get(column)).getId();

		case 1:
			return ((CrmProfissaoCliente) model.get(column)).getPfcTitulo();

		case 2:
			return ((CrmProfissaoCliente) model.get(column)).getPfcObservacao();
		case 3:
