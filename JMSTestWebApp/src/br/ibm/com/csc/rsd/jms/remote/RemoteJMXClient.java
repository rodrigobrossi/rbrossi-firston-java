package br.ibm.com.csc.rsd.jms.remote;
...
public class RemoteJMXClient {
    ...
    public static void main(String[] args) throws MalformedURLException, IOException {
        ...
        try {
     	    ...
     	    System.out.println("Domains:"+mbsc.getDomains()[0]);
     	   System.out.println("Domains:"+mbsc.getDomains()[1]);
     	  System.out.println("Domains:"+mbsc.getDomains()[2]);
     	 System.out.println("Domains:"+mbsc.getDomains()[3]);
     	   
            ObjectName on = ObjectNameBuilder.DEFAULT.getJMSQueueObjectName("brossiQueue");
