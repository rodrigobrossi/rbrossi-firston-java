...
"AND FUNCIONARIO.FUN_DEMITIDO = 'N' AND " + filtro_q + " " + filtro_nome + 
...
<body  onunload='return fecha();'  marginheight="0" leftmargin="14" topmargin="0" >
<form name="frm">
  <table width="90%" border="0" cellspacing="3" cellpadding="0">
    <tr> 
      <td width="43%" class="ctfontc"><div align="left"><%=trd.Traduz("LOCALIZAR POR FUNCIONARIO")%>:</div></td>
      <td width="23%"><input type="text" name="textnome" value="<%=opt_loc%>"></td>
      <td width="13%" class="ctfontc"><div align="left"><%=trd.Traduz("OPCOES")%>:</div></td>
      <td width="21%" ><select name="select2"onChange="return Opcao();">
...
%>
    ...
    <tr> 
      <td><input type="button" name="button" value=<%=("\""+trd.Traduz("FILTRAR")+"\"")%> class="botcin" onClick="return Filtro();"></td>
      <td colspan="3">&nbsp;</td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
  <tr> 
    <td colspan="100%" class="celtittab"><div align="center"><%=trd.Traduz("TREINAMENTOS NAO PLANEJADOS")%></div></td>
  </tr>
  <tr class="celtittab">
...
<%
                              ...
                              if (sel != -1){
                                rsgrid = conexao.executaConsulta(query_gridNP,session.getId()+"RS_2");
                                if (rsgrid.next()) {
                                    existe = true;
                                }
							  }
                           ...
                           if(existe){
								...
								do{%>
                                    <tr> 
                                      <td width="3%"  class="celnortab"><input type="checkbox" name="checknplan<%=i%>" value="<%=rsgrid.getString(1)%>"></td>
...
<table width="100%" border="0" cellspacing="3" cellpadding="0">
  ...
  <tr> 
    <td><div align="center">
        <input type="button" name="button1" value=<%=("\""+trd.Traduz("INCLUIR")+"\"")%> class="botcin" onClick="return Incluir();">
      </div></td>
  </tr>
