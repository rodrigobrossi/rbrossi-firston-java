...
<head>
<title>FirstOn - <%=trd.Traduz("Registro")%> - <%=trd.Traduz("LanCamentos Turma Longa DuraCAo")%></title>
          ...
          <td width="100%" align="center"> 
            <table border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td class="trontrk" width="297" align="center">LanCamentos Turma Longa DuraCAo</td>
        ...
        <tr> 
          ...
          <td valign="top"> <img src="../art/bit.gif" width="159" height="1"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                  <td height="20" class="ctfontc" align="center">&nbsp; ORDENACAO: 
                    <select name="select">
                      <option> </option>
                      <option>Funcion&aacute;rio</option>
                      <option>Curso</option>
                    </select>
								   &nbsp; &nbsp; TITULO: 
                    <select name="select">
              ...
              <tr> 
                <td>&nbsp;<br>
			 	<center>
                      <a href="09_criarlancamento.jsp"><img src="../art/bot1_lancar.gif" width="127" height="22" border="0"></a> 
                      <p>
