...
<head>
<title>FirstOn - <%=trd.Traduz("Cadastro")%> - <%=trd.Traduz("InclusAo de Curso")%></title>
          ...
          <td width="100%"> 
            <table border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td width="13"><img src="../art/bit.gif" width="13" height="15"></td>
                <td class="trontrk" width="196">InclusAo de Justificativa</td>
                <td width="44"><img src="../art/bit.gif" width="110" height="8"></td>
              </tr>
            </table>
          </td>
          <td width="20">&nbsp;</td>
                ...
                <table border="0" cellspacing="2" cellpadding="3" width="90%">
                  ...
                  <tr> 
                    <td align="center" colspan="3">&nbsp;<br>
                      <a href="justificativas.jsp"><img width="59" height="17" border="0" src="../art/bot_ok.gif"></a> 
                      &nbsp; <a href="justificativas.jsp"><img src="../art/bot_cancelar.gif" width="59" height="17" border="0"></a></td>
                  </tr>
                </table>
                <p>&nbsp;
              </center>
