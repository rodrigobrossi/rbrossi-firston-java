...
//Pega o tipo de cadastro (inclusAo ou alteraCAo) e o codigo da Justificativa
String tipo = "";
String cod = "1";
...
ResultSet rs = null;
String query = "SELECT JUS_CODIGO, JUS_NOME "+
			   "FROM JUSTIFICATIVA " + 
			   "WHERE JUS_CODIGO = " + cod + " ORDER BY JUS_NOME";                 
...
{
	%>
	<%=trd.Traduz("INCLUSAO DE JUSTIFICATIVA")%></title>
	<%
}
else
{
	%>
	<%=trd.Traduz("ALTERACAO DE JUSTIFICATIVA")%></title>
	<%
}
%>
...
function envia(){
    if (frm.jusnome.value == ""){
        alert(<%=("\""+trd.Traduz("O campo justificativa nAo pode ser nulo")+"\" ! ")%>);
        return false;
    }
    else{
	frm.submit();
    ...
    <td valign="top"> 
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <td width="100%" align="center"> 
            <table border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                if (tipo.equals("I")){
			%>
			<%=trd.Traduz("INCLUSAO DE JUSTIFICATIVA")%>
			<%
		}
		else{
			%>
			<%=trd.Traduz("ALTERACAO DE JUSTIFICATIVA")%>
			<%
		}
                %>
        ...
        <tr> 
		  ...
		  <FORM name = "frm" action="justifgrava.jsp" method="POST">
          <td valign="top"> <img src="../art/bit.gif" width="159" height="1">&nbsp;<br><center>
                <table border="0" cellspacing="2" cellpadding="3" width="90%">
                  <tr class="celnortab"> 
                    <td> 				
                      <p><%=trd.Traduz("NOME DA JUSTIFICATIVA")%><br>
                      <%
			if (tipo.equals("I")){
				%>
				<input type="text" name="jusnome" maxlength="50" size="70" onBlur="aspa2(this)" onKeyUp="aspa(this)">
				<%
			}
			else{
				...
				%>
				<input type="text" name="jusnome" maxlength="50" size="70" value="<%=rs.getString(2)%>" onBlur="aspa2(this)" onKeyUp="aspa(this)">
				<%}
			}
			%> &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
