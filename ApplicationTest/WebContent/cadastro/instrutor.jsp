...
String filtro = "", cod_empresa = "", empresa = "", query = "";
...
if (!(request.getParameter("filtro") == null)){ 
  filtro = " AND INS_NOME >= '" + request.getParameter("filtro") + "' ";
}

if (!(request.getParameter("empresa") == null)){ 
  if(request.getParameter("empresa").equals("todos")){
    cod_empresa = "";
  }
  else{
    cod_empresa = " AND I.EMP_CODIGO = " + request.getParameter("empresa");
  }
}

empresa = request.getParameter("empresa");

query = "SELECT I.INS_CODIGO, I.INS_NOME, E.EMP_NOME "+
        "FROM INSTRUTOR I, EMPRESA E " +
        "WHERE I.EMP_CODIGO = E.EMP_CODIGO "+
        filtro + cod_empresa + " "+
        "ORDER BY I.INS_NOME"; 
...
<head>
<title>FirstOn - <%=trd.Traduz("Cadastro")%> - <%=trd.Traduz("CADASTRO DE INSTRUTORES")%></title>
<script language="JavaScript" src="/js/scripts.js"></script>
<script language="JavaScript">
function filtra(){
  document.frm.tipo.value = "F";
  frm.action ="instrutor.jsp";
  frm.submit();
  return false; 
}
function inclui(){
    document.frm.tipo.value = "I";
  frm.action ="inclusaodeinstrutor.jsp";
  frm.submit();
  return false; 
}
function altera(){
    ...
    <td valign="top"> 
          ...
          <td width="100%" align="center"> 
            <table border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td class="trontrk" width="229"><%=trd.Traduz("CADASTRO DE INSTRUTORES")%></td>
                <td width="13"><img src="../art/bit.gif" width="13" height="15"></td>
              </tr>
            </table>
          </td>
      ...
      <FORM name = "frm">
          <td valign="top"> <img src="../art/bit.gif" width="159" height="1"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td height="12" colspan="2"><img src="../art/bit.gif" width="1" height="1"></td>
              </tr>
              <tr> 
                  <td height="20" class="ctfontc" align="center" colspan="2">&nbsp; <%=trd.Traduz("LOCALIZAR POR INSTRUTOR")%>: 
          ...
          <tr>
                  <td height="20" class="ctfontc" align="center" colspan="2"><br>&nbsp; <%=trd.Traduz("ENTIDADE")%>: 
                    <select name="empresa">
                    <option value="todos">TODOS</option>
                  <%
                  String queryEMP = "SELECT EMP_CODIGO, EMP_NOME FROM EMPRESA ORDER BY EMP_NOME";
                  rsEMP = conexao.executaConsulta(queryEMP,session.getId());
                  while(rsEMP.next()){
                    if(rsEMP.getString(1).equals(empresa)){
              ...
              <tr> 
                <td colspan="2" height="12"><img src="../art/bit.gif" width="1" height="1"></td>
              </tr>
              <tr> 
                <td colspan="2" class="ctvdiv" height="1"><img src="../art/bit.gif" width="1" height="1"></td>
              </tr>
              <tr>            
               <td colspan="2" align="center">&nbsp;<br>
                ...
                if (per.contains("CADASTRO INSTRUTOR - MANUTENCAO")){
                  mostraCheck=true;
                  %>     
                    <table border="0" cellspacing="0" cellpadding="0">
                      <tr> 
              ...
              <%
                    ...
                    <table border="0" cellspacing="1" cellpadding="2" width="80%">
                      <tr> 
                        ...
                        if(existe){
                          %>
                          <td width="48%" class="celtittab"><%=trd.Traduz("INSTRUTOR")%></td>
                          <td width="48%" class="celtittab"><%=trd.Traduz("ENTIDADE")%></td>
                          <%
                        }
                        else{
                          %><td colspan="2" class="celtittab" align="center"><%=trd.Traduz("NENHUM REGISTRO ENCONTRADO")%>...</td><%
                        }
                        %>
                      </tr>                     
                  <%                 
...
<%
if (rs!=null){conexao.finalizaConexao(session.getId());}
//if(rs != null){
  //rs.close();
//}
/*FINALIZAÇÕES*/
//conexao.finalizaConexao();
//conexaoEMP.finalizaConexao();
//conexaoEMP.finalizaBD();
%>