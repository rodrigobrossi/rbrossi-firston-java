...
function valida(teste) {
  if(document.form_c.cargo.checked){
    document.form_c.select_sol.disabled = true;
    document.form_c.select_cargo.disabled = false;
    document.form_c.select_sol.value  = "0";
    return true;
  }
  else if(document.form_c.sol.checked){
    document.form_c.select_cargo.disabled = true;
    document.form_c.select_sol.disabled = false;
    document.form_c.select_cargo.value  = "0";
    return true;
  }
}

function reload(){
  if(document.form_c.sol.checked){
    document.form_c.select_sol.disabled = false;
    document.form_c.select_cargo.disabled = true;
  }
  if(document.form_c.cargo.checked){
...
*/
function valida2() {
  if((document.form_c.select_sol.value=="0")&&(document.form_c.select_cargo.value=="0")) {
    alert(<%=("\""+trd.Traduz("Escolha um SOLICITANTE ou um CARGO")+"\"")%>);
    return false
  }
  if (!(document.form_c.ind_atual.checked) && !(document.form_c.ind_requerido.checked)) {
    alert(<%=("\""+trd.Traduz("Escolha INDICE ATUAL ou INDICE Requerido")+"\"")%>);
    return false
  }
  form_c.action = "02_matrizdecompetencias.jsp";
  form_c.submit();
}
...
<head>
<title>FirstOn - <%=trd.Traduz("IMPRESSOES")%> - <%=trd.Traduz("MATRIZ DE COMPETENCIAS")%></title>
  ...
  <tr> 
          ...
          <td width="100%" align="center"> 
            <table border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td class="trontrk" align="center"><%=trd.Traduz("MATRIZ DE COMPETENCIAS")%></td>
    ...
    <FORM name="form_c">
            ...
            if(usu_tipo.equals("S"))
          {
            ...
            <input type="hidden" name="select_sol" value="0">
            <%
          }
          ...
          {
            %>
                        <td width="3%" class="ftverdanacinza"><input type="radio" id="sol" name="radio1" value="sol" OnClick="return valida(this);" checked></td>
                        <td width="10%" class="ftverdanacinza"><%=trd.Traduz("Solicitante")%>:</td>
                ...
                <option value="0"><%=trd.Traduz("Escolha um Solicitante")%></option>
                  ...
                  <tr valign="middle">
                    ...
                    {
                      %>
                      <input type="radio" checked id="cargo" name="radio1" value="cargo" OnClick="return valida(this);">
                      <%
                    }
                    else
                    {
                      %>
                      <input type="radio" name="radio1" id="cargo" value="cargo" OnClick="return valida(this);">
                      <%
                    }
                    %>
                    </td>
      ...
      <td colspan="3">&nbsp;</td>
                  ...
                  <tr valign="middle"> 
                    <td align="right" class="ftverdanacinza"> 
                      <input type="checkbox" name="fun_null" value="checkbox">
                    </td>
                    <td colspan="2" class="ftverdanacinza"><%=trd.Traduz("Incluir funcionArios sem curso")%></td>
                  </tr>
                  <tr valign="middle"> 
                    <td align="right" class="ftverdanacinza"> 
                      <input type="checkbox" name="ind_atual" value="checkbox">
                    </td>
                    <td colspan="2" class="ftverdanacinza"><%=trd.Traduz("Indice atual")%></td>
                  </tr>
                  <tr valign="middle"> 
                    <td align="right" class="ftverdanacinza"> 
                      <input type="checkbox" name="ind_requerido" value="checkbox">
                    </td>
                    <td colspan="2" class="ftverdanacinza"><%=trd.Traduz("Indice requerido")%></td>
                  </tr>
                  </table>
                  <br>
