...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
   ...
   /**
    ...
    private void initComponents() {
        ...
        backButton = new JButton(new ImageIcon("br/com/firston/wizard/backIcon.gif"));
    ...
    private static Object getImage(String name) {
        ...
        try {
            Class c = Class.forName("br.com.firston.wizard.Wizard");
    ...
    static {
        ...
        try { 
            ...
            PropertyResourceBundle resources = (PropertyResourceBundle)
                ResourceBundle.getBundle("br.com.firston.wizard.wizard");
